...
func SetAppName(userApp string) error {
	UserAgent = fmt.Sprintf(
		"QiniuGo/%s (%s; %s; %s) %s", base.Version, runtime.GOOS, runtime.GOARCH, userApp, runtime.Version())
	return nil
}
...
func newRequest(ctx context.Context, method, reqUrl string, headers http.Header, body io.Reader) (req *http.Request, err error) {
	...
	//check access token
	mac, t, ok := base.CredentialsFromContext(ctx)
	if ok {
	...
	if DebugMode {
		trace := &httptrace.ClientTrace{
			GotConn: func(connInfo httptrace.GotConnInfo) {
				...
				Debug(fmt.Sprintf("Network: %s, Remote ip:%s, URL: %s", remoteAddr.Network(), remoteAddr.String(), req.URL))
			},
		}
...
func (r Client) CredentialedCallWithForm(ctx context.Context, cred *base.Credentials, tokenType base.TokenType, ret interface{},
	method, reqUrl string, headers http.Header, param map[string][]string) error {
	ctx = base.WithCredentialsType(ctx, cred, tokenType)
	return r.CallWithForm(ctx, ret, method, reqUrl, headers, param)
}

func (r Client) CredentialedCallWithJson(ctx context.Context, cred *base.Credentials, tokenType base.TokenType, ret interface{},
	method, reqUrl string, headers http.Header, param interface{}) error {
	ctx = base.WithCredentialsType(ctx, cred, tokenType)
	return r.CallWithJson(ctx, ret, method, reqUrl, headers, param)
}

func (r Client) CredentialedCallWith(ctx context.Context, cred *base.Credentials, tokenType base.TokenType, ret interface{},
...
func (r Client) CredentialedCallWith64(ctx context.Context, cred *base.Credentials, tokenType base.TokenType, ret interface{},
...
func (r Client) CredentialedCall(ctx context.Context, cred *base.Credentials, tokenType base.TokenType, ret interface{},
